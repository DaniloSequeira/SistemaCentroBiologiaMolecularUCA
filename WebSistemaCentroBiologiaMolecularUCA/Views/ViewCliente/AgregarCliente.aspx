 <%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AgregarCliente.aspx.cs" Inherits="WebSistemaCentroBiologiaMolecularUCA.Views.ViewCliente.AgregarCliente" %>
        ...
        <strong class="card-title">Nuevo Cliente</strong>
                        ...
                        <div class="card-body card-block">
                            ...
                            <div >
                                ...
                                <div class="col-12 col-md-3"> &nbsp;
                                    <asp:DropDownList ID="Mdepartamento" runat="server" ToolTip="Departamento" CssClass="form-control" OnSelectedIndexChanged="Mdepartamento_SelectedIndexChanged" AutoPostBack="true">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <asp:DropDownList ID="Mmunicipio" runat="server" ToolTip="Municipio" CssClass="form-control">
